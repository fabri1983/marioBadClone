...
/// Also it lets add other layers defined by the user, as in the Unity's layer concept, this way the 
/// game object can belong to several layers.
/// </summary>
public class CollisionLayersCP : MonoBehaviour {
	
	private const int LAYERS = 16; // set here what is the max layer you defined on Layers window
	
	// add in the Inspector all the layers you want this game object belongs to
	public int[] otherLayersBelongTo;
	
	public void Start(){
		// start from current game object layer
