...
The colliders are created within the Unity3D editor and add no additional
...
-----------------------------------------------------------
Workflow at a typical scene with SmoothMoves and Orthello
-----------------------------------------------------------
...
generate the MeshColliders. At these components you can tweak parameters
such as the number of outline vertices, convexity of the mesh, etc.
...
3) Select all objects that you wish to add a generated MeshCollider to.
